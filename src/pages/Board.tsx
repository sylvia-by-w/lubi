...
const styles: Record<string, CSSProperties> = {
  ...
  projectHeadCell: { textAlign: 'center', width: 92 },
  projectRowLabel: { border: '1px solid var(--border-soft)', background: 'var(--surface-soft)', padding: '5px 8px', fontSize: 13, fontWeight: 700, color: 'var(--text-primary)', cursor: 'grab', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', textAlign: 'center' },
